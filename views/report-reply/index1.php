...
<span style="white-space: pre;">
   ...
   <span class="badge badge-danger">Admin / Seller </span>
    </p>
</div>';
        }
    }
    ...
    <div class="col-lg-6">
        ...
        <div class="card card-body">
            ...
            <div class="card-body">
                Report Solved     :   <label class="badge badge-warning" style="color: white"><?=$status?></label>
                <hr/>
                Customer Email    :   <label><?=Yii::$app->session->get('user_email')?></label>
                <br/>
...
<div class="col-lg-6">
    ...
    <?= $form->field($model, 'user_id')->hiddenInput(['value'=> $ticket_user_id])->label(false);?>
