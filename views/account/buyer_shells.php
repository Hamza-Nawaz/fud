                            ...
                            'columns' => [
                                ...
                                ['header'=>'Check Shell',
                                    ...
                                    'value' => function($data) {
                                        ...
                                        return Html::a('Check Shell', "javascript:void(0);", ['class' => 'btn btn-primary btn-shell-check', 'data-id' => $data->id]);
...
<script>
    ...
    function checkCp(elm) {
        ...
        $.ajax({
            url: base_url+"/account/check-shell",
            type: "POST",
            data: "data=" + data,
    ...
    $(document).ready(function(){
        ...
        $(".btn-shell-check").click(function(){
            $(this).text("Verifying...");
            checkCp($(this));
        });
